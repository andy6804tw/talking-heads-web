...
var Modal = function (e) {
  ...
  var h = function () {
    ...
    k = function (e) {
      function t() {
        ...
        if (n.id = a(), n.el = null, n._html = {}, n._events = {}, n._visible = !1, n._options = u({}, t.options, e), n._templates = u({}, t.templates, e.templates || {}), n._html.appendTo = document.querySelector(n._options.appendTo), null === n._options.buttons && (n._options.buttons = t.buttons.dialog), n._options.el) {
          var s = n._options.el;
      ...
      return s(t, e), h(t, null, [{
        ...
        value: function value(e) {
          ...
          c(e.target).every(function (n) {
            return !("HTML" === n.tagName || n.classList.contains("modal-content") || ("modal" === n.getAttribute("data-dismiss") ? (t.emit("dismiss", t, e, l(e.target, "button")), t.hide(), 1) : n.classList.contains("modal") && (t.emit("dismiss", t, e, null), t.hide(), 1)));
          });
        }
      }, {
        ...
        value: function value() {
          ...
          this._html.container.style.paddingLeft = !this.bodyIsOverflowing && e ? _ + "px" : "", this._html.container.style.paddingRight = this.bodyIsOverflowing && !e ? _ + "px" : "";
        }
      }, {
        key: "_backdrop",
        value: function value() {
        ...
        value: function value() {
          ...
          return this.emit("hide", this), i.remove(n.animateInClass), o.remove(n.animateInClass), this._removeEvents(), setTimeout(function () {
            ...
            t.backdrop.parentNode.removeChild(t.backdrop), t.container.style.display = "none", n.construct && t.container.parentNode.removeChild(t.container), e._visible = !1, e.emit("hidden", e);
          }, n.transition), this;
        }
      }, {
        key: "_removeEvents",
  ...
  e.exports = n, n.EventEmitter = n, n.prototype._events = void 0, n.prototype._maxListeners = void 0, n.defaultMaxListeners = 10, n.prototype.setMaxListeners = function (e) {
    ...
    if (this._events || (this._events = {}), "error" === e && (!this._events.error || s(this._events.error) && !this._events.error.length)) {
      if (_instanceof(t = arguments[1], Error)) throw t;
